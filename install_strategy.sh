...
#
# Usage:
#   curl -sSL https://raw.githubusercontent.com/okx/plugin-store/main/install_strategy.sh | sh -s -- <strategy-name>
#
...
CACHE_BASE="$HOME/.plugin-store"

# 脚本下载基础 URL，私有仓库或镜像场景下可通过环境变量覆盖
